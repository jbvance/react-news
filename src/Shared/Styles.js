...
export const color3 = lightTheme ? '#478214' : '#42ff3a';
...
export const fontColorBlack = `color: black`;
...
export const fontSize2 = 'font-size: 1.3em;';
export const fontSize3 = 'font-size: 1.0em';
export const fontSize4 = 'font-size: .75em';
